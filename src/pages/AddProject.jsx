  ...
  return (
    <div className="p-4 md:p-8 max-w-4xl mx-auto">
      <div className="mb-8 md:mb-12">
        <h2 className="text-2xl md:text-4xl font-serif italic mb-2">Add Project</h2>
        <p className="text-text-secondary text-xs sm:text-sm">Define a new workspace and set milestones for your next high-performance deliverable.</p>
      </div>
      ...
      <form className="space-y-10" onSubmit={(e) => e.preventDefault()}>
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between pt-8 border-t border-dark-border gap-4">
          ...
          <div className="flex gap-4 w-full sm:w-auto">
            <button className="flex-1 sm:flex-none px-6 md:px-8 py-3 border border-dark-border rounded-md text-xs font-bold uppercase tracking-widest hover:bg-white/5 transition-colors">
              Cancel
            </button>
            <button className="flex-1 sm:flex-none px-6 md:px-8 py-3 bg-white text-black rounded-md text-xs font-bold uppercase tracking-widest hover:bg-white/90 transition-colors">
              Create Project
            </button>
          </div>
        </div>
